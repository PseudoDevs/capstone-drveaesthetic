...
use App\Filament\Resources\MedicalCertificateResource\Api\Requests\UpdateMedicalCertificateRequest;
...
class UpdateHandler extends Handlers {
     ...
     */
    public function handler(UpdateMedicalCertificateRequest $request)
    {
        $id = $request->route('id');
