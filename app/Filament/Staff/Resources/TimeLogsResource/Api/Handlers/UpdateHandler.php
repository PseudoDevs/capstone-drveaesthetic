...
use App\Filament\Staff\Resources\TimeLogsResource\Api\Requests\UpdateTimeLogsRequest;
...
class UpdateHandler extends Handlers {
     ...
     * Update TimeLogs
     *
     * @param UpdateTimeLogsRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateTimeLogsRequest $request)
    {
        $id = $request->route('id');
